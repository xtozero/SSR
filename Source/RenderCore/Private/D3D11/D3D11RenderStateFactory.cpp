...
namespace
{
	constexpr TCHAR* SAMPLER_STATE_DESC_FILE_NAME = _T( "./Scripts/SamplerStateDesc.txt" );
	constexpr TCHAR* RASTERIZER_STATE_DESC_FILE_NAME = _T( "./Scripts/RasterizerStateDesc.txt" );
	constexpr TCHAR* BLEND_STATE_DESC_FILE_NAME = _T( "./Scripts/BlendStateDesc.txt" );
	constexpr TCHAR* DEPTH_STENCIL_DESC_FILE_NAME = _T( "./Scripts/DepthStencilDesc.txt" );
}
