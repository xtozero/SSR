...
struct RE_HANDLE
{
	...
	{
		return RE_HANDLE( GraphicsResourceType::COUNT, std::numeric_limits<std::size_t>::max( ) );
	}

	constexpr RE_HANDLE( GraphicsResourceType type, std::size_t index ) : m_type( type ), m_index( index )
	{}

	constexpr RE_HANDLE( GraphicsResourceType type ) : m_type( type ), m_index( std::numeric_limits<std::size_t>::max( ) )
	{}

	constexpr RE_HANDLE( ) : m_type( GraphicsResourceType::COUNT ), m_index( std::numeric_limits<std::size_t>::max( ) )
	{}
