...
namespace
{
	void ConvertVertexLayoutToInputLayout( std::vector<D3D12_INPUT_ELEMENT_DESC>& descs, const VertexLayoutTrait* trait, uint32 size )
	{
...
namespace agl
{
	...
	D3D12VertexLayout::D3D12VertexLayout( const VertexLayoutTrait* trait, uint32 size )
	{
