...
namespace agl
{
	...
	private:
		...
		ID3D11SamplerState* m_samplerStates[NumNonRTShaderTypes<uint32>][D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT] = {};

		ID3D11ShaderResourceView* m_srvs[NumNonRTShaderTypes<uint32>][D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT] = {};
		...
		ID3D11Buffer* m_constantBuffers[NumNonRTShaderTypes<uint32>][D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT] = {};
