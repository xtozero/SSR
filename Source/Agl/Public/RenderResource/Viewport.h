...
namespace agl
{
	...
	{
	public:
		AGL_DLL static RefHandle<Viewport> Create( uint32 width, uint32 height, void* hWnd, ResourceFormat format, const float4& bgColor, bool useDedicateTexture );
