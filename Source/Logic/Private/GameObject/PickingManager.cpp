...
//namespace
//{
//	void WindowSpace2NDCSpace( Vector& pos, const logic::VIEWPORT& veiwport )
//	{
//		//뷰포트 기준으로 변환
...
//namespace logic
//{
//	void CPickingManager::ProcessInput( const engine::UserInput& input, CGameLogic& /*gameLogic*/ )
//	{
//		switch ( input.m_code )
//		{
//		case UIC_MOUSE_LEFT:
...
//	}
//
//	void CPickingManager::OnMouseLButton( const engine::UserInput& input )
//	{
...
//	}
//
//	void CPickingManager::OnMouseMove( const engine::UserInput& input )
//	{
