...
public:
	...
	IShaderResource* TryCreateShaderResource( ID3D11Device* pDevice, const ITexture* pTexture, const D3D11_TEXTURE2D_DESC& desc, const String& textureName, int srcFlag = 0 );
