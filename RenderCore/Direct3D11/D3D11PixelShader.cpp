...
{
	m_renderStateManager.SetPixelShader( m_pPixelShader.Get( ), nullptr, 0 );
}
...
void D3D11PixelShader::SetShaderResource( UINT slot, const IRenderResource* pResource )
{
	...
	m_renderStateManager.SetPsShaderResource( slot, 1, &srv );
}
...
D3D11PixelShader::D3D11PixelShader( CD3D11RenderStateManager& renderStateManager ) :
