...
public:
	...
	virtual bool RegisterTexture2D( const String& textureName, void* pTexture ) = 0;
	...
	virtual IRenderResource* CreateRenderTarget( const ITexture* pTexture, const String& renderTargetName, const TEXTURE_TRAIT* trait = nullptr ) = 0;
	virtual IRenderResource* CreateDepthStencil( const ITexture* pTexture, const String& depthStencilName, const TEXTURE_TRAIT* trait = nullptr ) = 0;
	...
	virtual IRenderResource* CreateShaderResource( const ITexture* pTexture, const String& resourceName, const TEXTURE_TRAIT* trait = nullptr ) = 0;
