...
public:
	...
	virtual bool CreateShaderResource( ID3D11Device* pDevice, std::shared_ptr<ITexture>& pTexture, const D3D11_SHADER_RESOURCE_VIEW_DESC& desc ) override;
	...
	CShaderResource();
	explicit CShaderResource( const int srcFlag );
